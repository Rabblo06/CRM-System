...
const GROUP_COLORS = ['#4762D5', '#4762D5', '#8B5CF6', '#F59E0B', '#EF4444', '#3B82F6', '#10B981', '#F97316'];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
      <div className="bg-white rounded-lg shadow-2xl flex flex-col" style={{ width: 860, maxHeight: '90vh', border: '1px solid #EBEBEB' }}>
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#EBEBEB] flex-shrink-0">
          <span className="text-base font-bold text-[#333333]">Import to Contacts</span>
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {step === 2 && (
            <div className="px-6 py-5">
              ...
              <p className="text-xs text-[#999999] text-center mb-5">
          ...
          {step === 3 && (
            <div className="flex flex-col items-center py-12 px-8">
              ...
              <p className="text-sm text-[#999999] mb-8">A "match" means a row has the same email as an existing contact.</p>
            ...
            <div className="flex flex-col items-center py-16 px-8">
              {importing ? (
                <>
                  ...
                  <p className="text-base font-bold text-[#333333] mb-2">Importing contacts…</p>
                  ...
                  <p className="text-xs text-[#B3B3B3] mt-3">Please don't close this window</p>
                </>
              ) : result && (
                <>
                  ...
                  <div className="flex flex-col gap-1 items-center">
                    <p className="text-sm text-[#666666]"><span className="font-bold text-[#4CAF8E]">{result.success}</span> contacts imported</p>
